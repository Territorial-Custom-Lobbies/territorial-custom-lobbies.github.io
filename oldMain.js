      ...
      try {
        ...
        i.j(
          ...
          new k(
            ...
            c +
              "<br>Please report this error message to davidtschacher@gmail.com. Please also describe the actions you took before this error occurred.",
            true,
            [
              new l(
                "🔄 Reload",
...
function r3() {
  ...
  function rN() {
    ...
    if (data[100].em === 0) {
      data[100].value = data[100].rA =
        (m.id === 0 ? "Player " : m.id === 1 ? "Android User " : "iOS User ") + Math.floor(1000 * Math.random());
    }
  }
  function rO() {
    var z, el;
...
function dE() {
  ...
  function wS(d) {
    ...
    i.j(
      4,
      5,
      new k("🚀 New Game Update", "The game has been updated! Please reload the game.", true, [
        new l(L(13), function () {
          i.wb();
        }),
        new l(
...
function bu() {
  ...
  function a0Y() {
    ...
    tU.setTransform(
      ...
      0,
      a0Z,
      Math.floor((ir - a0Z * aP.get(0).width) / 2),
      Math.floor((ir - a0Z * aP.get(0).height) / 2)
    );
...
function bv() {
  ...
  this.tc = function (tb) {
    a0v(
      300,
      tb[0].name + " [" + a1.vR.ti(tb[0].tf) + "] vs " + tb[1].name + " [" + a1.vR.ti(tb[1].tf) + "]",
      65,
      0,
      p.mC,
...
function c0() {
  ...
  function a3X(a3Y, a1A) {
    return (
      Math.pow(a3Y - (eP + t / 2), 2) + Math.pow(a1A - (eR + t / 2), 2) < (t * t) / 4 ||
      Math.pow(a3Y - (eP + t / 2), 2) + Math.pow(a1A - (eR + 2 * t), 2) < (t * t) / 4
    );
  }
  this.tP = function () {
    return -hg / hh;
...
function c1() {
  ...
  this.dH = function () {
    ...
    a3z();
    ey = [
      208644377, 208644377, 208644377, 206964709, 205156594, 250680803, 249089835, 234476552, 252346209, 263196406,
      270821533, 291436400, 294907103, 288866179, 297960890, 310165928, 323215738, 326005712, 312078872, 282668674,
      268883231, 261100885, 247870209, 240175828, 231697235, 240614202, 237647174, 230525212, 228239099, 226070733,
      215992739, 216961676, 231079584, 235793502, 234032821, 228402462, 216942832, 211862670, 209792418, 220626495,
      221020535, 228198633, 226910806, 227687295, 210969547, 197393506, 205629061, 215820135, 213694935, 209455870,
      215822584, 215130299, 214034219, 229190414, 230055290, 225313791, 223398523, 231870169, 226224938, 218242706,
      235891029, 210498444, 195329116, 187676007, 183432634, 175752106, 170096205, 173369342, 171454357, 185810310,
      189616577, 190788861, 179291487, 179513980, 189122353, 188375572, 202060722, 203256609, 197948652, 191950448,
      194693217, 196335490, 195911919, 202264283, 199251620, 193699336, 188441210, 183419345, 195919988, 198126823,
      199780788, 197440550, 190144884, 179139362, 166469099, 178827877, 183801980, 197952484, 188875861, 185919783,
      186237411, 182504952, 183532013, 174109004, 178159701, 161031347, 194622838, 205645645, 200496457, 194773327,
      194546481, 207893217, 210920126, 213376144, 173859897, 154326886, 158943729, 166772975, 175066046, 177406405,
      179018562, 185986119, 186747583, 200787939, 208959937, 161987576, 185512400, 185788899, 185957487, 194591063,
      215634157, 230579314, 237637383, 240518707, 221398239, 225230795, 224891285, 211292916, 216944626, 219436299,
      226523918, 232405568, 232166426, 216921782, 244767964, 257278946, 243548100, 237386943, 242802627, 229717622,
      168149709, 259971896, 267057767, 257606635, 209857364, 126035568, 129833237, 151312703, 197006695, 73120657,
      37551024, 39229432, 29517736, 29382631, 31512045, 42652097, 47363019, 49624906, 46687310, 33767120, 31230439,
      34211643, 43094531, 53747053, 55380682, 49779117, 47748833, 21038802, 20406484, 24523793, 26566139, 25284142,
      26825553, 23497443, 20291865, 17765022, 21291320, 21106123, 19050128, 18324426, 19044067, 19594721, 19347845,
      23365124, 24186529, 19824881, 17952812, 17093838, 17328579, 17607296, 21284737, 22551012, 20471281, 19350848,
      19654931, 18725460, 18641926, 23301269, 25178902, 21617041, 21433781, 21078957, 19526047, 18665064, 21394401,
      21575049, 19286677, 18018450, 17550775, 17282428, 17055509, 19348704, 20177845, 19766211, 19088037, 18118802,
      18269428, 18500614, 19130220, 19351798, 19205188, 19489961, 20233286, 20726811, 23245145, 26158741, 26096642,
      24424181, 23690661, 22967492, 21098008, 20325973, 19431907, 17008295, 15583096, 14209752, 14307184, 13541498,
      12822679, 13154311, 12161194, 12956543, 11435697, 13428928, 12262514, 12858519, 12405344, 12884309, 14410011,
      15556681, 15260178, 14863807, 13861458, 15176144, 14089849, 13063987, 12378716, 13061867, 13118900, 13112653,
      13137263, 13062253, 13126875, 14136833, 14711852, 14341250, 11888270, 13137006, 12830841, 12516937, 12783789,
      13139393, 12931000, 12857582, 13677329, 13892963, 13171528, 14135236, 14640750, 15677970, 16758399, 19125177,
      17723446, 16469484, 17032884, 19792603, 21426397, 22032534, 20271251, 16190176, 16772813, 17675977, 18764026,
      18346209, 19576834, 20989792, 21350839, 14696885, 14653075, 14677999, 14958759, 14210260, 15488352, 15623604,
      14473144, 12823062, 14869909, 15142264, 15567014, 17896725, 20081347, 17765006, 12763925, 13523610, 13979983,
      15080856, 17116394, 18483238, 18084320, 12100282, 12221529, 12441579, 12058220, 12441689, 12821546, 13401583,
      13009895, 12271066, 12210094, 12355642, 13737115, 14257807, 14904897, 14072161, 15640387, 15721803, 16397970,
      19254839, 21608906, 20527471, 16596206, 15550563, 14385591, 15547262, 13174302, 12462319, 13000669, 12832541,
      12186376, 13150940, 14654379, 14299386, 14158528, 15185971, 12444117, 14253445, 15049053, 14123310, 16892853,
      15963931, 11858727, 10012703, 9478191, 9193460, 8851082, 9298848, 9638204, 9442496, 8653593, 9093527, 8530977,
      8809114, 9609612, 9906912, 9615756, 9477879, 9713075, 9126583, 8949378, 9577595, 10180186, 9858705, 9534213,
      9184660, 8889455, 8311313, 9738346, 9772164, 9157791, 8445413, 8467279, 8756002, 9257951, 10213536, 10620530,
      10352296, 9350531, 9118709, 9614237, 9692491, 10801215, 10984804, 9542309, 9609538, 9391430, 9515517, 10064494,
      11061684, 10408005, 9794768, 9297643, 9275992, 9394076, 9716084, 10045958, 9715229, 9091248, 10010584, 9845528,
      9532588, 8986320, 9037708, 9820996, 8953464, 9074064, 8644692, 8025308, 8832112, 10785788, 10539708, 8908744,
      8331216, 8858100, 8626840, 7666284, 8503372, 8855308, 6762540, 6414076, 6786692, 6445532, 6262192, 5918176,
      5864376, 5464928, 5384996, 5942760, 5261972, 5404612, 6184860, 6312948, 5815660, 5208552, 4734392, 4538784,
      4661404, 5145524, 4819368, 4369224, 4458584, 4289956, 3538288, 3517544, 3871876, 3388048, 3344796, 3089228,
      2863676, 2268964, 2160500, 2580004, 2244356, 2018408, 1688912, 1945368, 1796332, 1619260, 2060292, 1597656,
      1472788, 1306208, 1171408, 1021096, 1109312, 1241276, 1305092, 1142748, 1157700, 991984, 786992, 786396, 1043956,
      1029320, 860500, 834824, 841912, 736464, 690328, 878376, 907232, 794932, 646388, 752600, 672836, 636212, 794108,
      746856, 642928, 671328, 493568, 458168, 428776, 464736, 371412, 314568, 225472, 252072, 227604, 251048, 269184,
      174136, 825576, 536060, 165952, 153252, 180036, 149616, 138472, 157832, 188152, 180108, 134076, 70960, 89236,
      111428, 60520, 74620, 73424, 74720, 71584, 94432, 62572, 66420, 32532, 34452, 41048, 51372, 61916, 43236, 55172,
      26776, 47000, 57424, 93100, 64980, 37288, 44296, 34588, 40700, 29200, 24604, 18184, 42660, 31404, 38096, 18556,
      17388, 19568, 17604, 22328, 40300, 39392, 33440, 17960, 7984, 11612, 67700, 14108, 22444, 19756, 9436, 16864,
      14400, 17216, 14436, 8612, 15952, 29764, 18748, 16348, 23976, 22080, 20268, 20984, 9480, 30736, 15996, 9484, 9392,
      9716, 21540, 57428, 24788, 18728, 8528, 5972, 20560, 18268, 28088, 15364, 15300, 29348, 30992, 20564, 34420,
      16716, 14424, 12360, 15124, 51172, 13176,
    ];
    this.resize();
  };
  this.resize = function () {
...
function c3() {
  ...
  function a54() {
    ...
    a4b.setTransform(
      ...
      0,
      a0Z,
      Math.floor(a4i + 0.58 * a4h + 0.5 * a0Z * aP.get(4).width),
      Math.floor(a4e + a4X + 0.4 * a4h)
    );
...
function a6M() {
  this.L84 = [
    ...
    "You have earned prize money of {10} gold.",
    "The following clans have won these glorious points:",
    "Validate the clan results by clicking here: ",
    "❌ Back",
    "⚠️ Error",
    "Error {10}",
    "Not Enough Gold!",
    ...
    "Income",
    "Time",
    "Hint: Click on a boat to send it to a new location.",
    ...
    "Played Games: ",
    "Report Player",
    "You can report up to seven players per day for misconduct or other rule violations.",
    "No Admin",
    "Assistant Moderator",
    "Admin Coordinator",
    "Senior Admin",
    ...
    "Points: ",
    "Status: ",
    "You are allowed to elect up to one admin each week. Negative votes count only half as much as positive votes.",
    "Username",
    ...
    "No Clan Leader",
    "Elect",
    "You are allowed to elect up to one clan leader each week. Your voting power is based on your monthly clan points.",
    "You can only elect members of the same clan you have won points for.",
    "Clan Chart",
    "🛠️ Options",
    "🛠️ Chart Options",
    "Search Terms",
    ...
    "Terms",
    "Privacy",
    "Do you want to delete all locally stored data, like usernames, account data and setting data?",
    "Accounts without gold will be deleted after some days of grace.",
    "🗑️ Delete",
    "User Privacy",
  ...
  this.gV = function (hO, hP) {
    ...
    for (z = el.length - 1; z >= 0; z--) {
      if (
        ...
        hO > eP[z] &&
        hP > eR[z] &&
        hO < eP[z] + lw[z] * ed[z].width &&
        hP < eR[z] + lw[z] * ed[z].height
      ) {
  ...
  this.xL = function (eP, eR, a75, size) {
    for (var z = a75; z < a75 + size; z++) {
      if (
        eP >= this.pP[z].eP &&
        eR >= this.pP[z].eR &&
        eP <= this.pP[z].eP + this.pP[z].t &&
        eR <= this.pP[z].eR + this.pP[z].ir
      ) {
        return z;
      }
    }
...
function a77() {
  ...
  this.wt = function (kU, kV, deltaY) {
    ...
    this.colors[this.a79][z] = a7E(
      this.colors[this.a79][z] + (deltaY < 0 ? 1 : -1) * Math.max(Math.abs(0.05 * deltaY), 1)
    );
    bU.dO = true;
  };
  this.gV = function (kU, kV) {
    ...
    if (
      ...
      kU >= this.t - 1 ||
      kV >= this.ir - 1 ||
      (kU > this.t - (0.4 * this.a6g + 3 * this.gap) && kV < this.a6g)
    ) {
      this.to = false;
      bU.dO = true;
      return false;
  ...
  this.qn = function () {
    ...
    qo.fillText(
      "Choose Your Nation's Color!",
      Math.floor((this.t - this.gap - 0.4 * this.a6g) / 2),
      Math.floor(0.55 * this.a6g)
    );
    this.a7I(0);
    qo.lineWidth = bR.uH;
    this.a7J(0);
    ...
    this.a7J(2);
    a9.a0g(
      Math.floor(lk + this.t - 0.4 * this.a6g - this.gap),
      Math.floor(ll + 0.3 * this.a6g),
      Math.floor(0.4 * this.a6g)
    );
    qo.setTransform(1, 0, 0, 1, 0, 0);
  };
  this.a7I = function (z) {
    ...
    qo.fillText(
      "National Color",
      Math.floor(-1.5 * this.gap - this.a6g - this.a7A),
      Math.floor(this.gap + 0.5 * this.a7A)
    );
    qo.rotate(Math.PI / 2);
  };
  this.a7J = function (z) {
    ...
    qo.fillRect(
      2 * this.gap + this.a7A,
      this.a6g + this.gap + z * (this.gap + this.a7C),
      Math.floor((this.colors[this.a79][z] * this.a7B) / 255),
      this.a7C
    );
    qo.strokeStyle = p.mL;
    ...
    qo.fillText(
      (z === 0 ? "Red: " : z === 1 ? "Green: " : "Blue: ") + this.colors[0][z].toString(),
      3 * this.gap + this.a7A,
      Math.floor(this.a6g + this.gap + z * (this.gap + this.a7C) + 0.53 * this.a7C)
    );
  };
}
function c7() {
...
function cY() {
  ...
  function a8T(z, y6) {
    ...
    h1.setTransform(
      ...
      0,
      zoom,
      Math.floor((a8E - zoom * y6.width) / 2),
      Math.floor((a8E - zoom * y6.height) / 2)
    );
    h1.drawImage(y6, 0, 0);
    h1.setTransform(1, 0, 0, 1, 0, 0);
  }
  ...
  function a93(z, eP, eR) {
    ...
    qo.setTransform(
      ...
      0,
      zoom,
      Math.floor(eP + (a87 - zoom * ed.width) / 2),
      Math.floor(eR + (a87 - zoom * ed.height) / 2)
    );
    qo.globalAlpha = 0.6;
    qo.drawImage(ed, 0, 0);
    qo.globalAlpha = 1;
  ...
  function a8v() {
    ...
    qo.setTransform(
      ...
      0,
      zoom,
      Math.floor(a8O - 0.56 * zoom * aP.get(0).width),
      Math.floor(a8P - 0.5 * zoom * a95)
    );
...
function cB() {
  ...
  this.tD = function (dy, player) {
    var eK = this.eK;
    return (
      this.aA6(dy + eK[0], player) ||
      this.aA6(dy + eK[1], player) ||
      this.aA6(dy + eK[2], player) ||
      this.aA6(dy + eK[3], player)
    );
  };
...
function cx() {
  ...
  this.dH = function () {
    ...
    while (aFW) {
      aFV = aFW.nextSibling;
      if (
        document.body.contains(aFW) &&
        (aFW.tagName === "DIV" || aFW.tagName === "INPUT" || aFW.tagName === "BUTTON")
      ) {
...
function aFe(data) {
  ...
  var aFp;
  function dH() {
    aFo = new qU(data.username, [
      new l(L(13), function () {
        b8.clear();
        i.wb();
      }),
      new l(
        data.aFq ? "🔄 " + L(135) : L(136),
        function () {
          i.j(
            8,
            i.a9d().aFX,
  ...
  function aFz() {
    ...
    aG5.oo(
      new pd([
        new l(
          L(160) + bY.dZ.data[105].value,
          function () {
            i.j(
              4,
              0,
              new k(L(161), L(162), true, [
                new l(L(13), function () {
                  i.j(7, i.aFn(7).aFX);
                }),
              ])
  ...
  function aG1() {
    ...
    aG5.oc(L(167));
    aG5.oj(
      L(168) + b2.w0.zD(data.rd, 0.1, 1) + "<br>" + L(169) + (data.re + 1) + " / " + data.rg + "<br>" + L(170) + data.rf
    );
    if (data.aFq) {
      aG5.oo(
        new pd([
...
function aGW(data) {
  ...
  function dH() {
    ...
    aFo = new qU(
      L(204) + ", " + aGm[data.aGn] + ", " + b2.xk.yK(aGc),
      [
        new l(L(13), function () {
          i.kt.a6a();
        }),
  ...
  function a0g(aGu, aGw, aGv) {
    ...
    qo.stroke();
    qo.beginPath();
    qo.arc(aGe, aH4, 0.1 * aGX, 0, 2 * Math.PI);
...
function aFZ() {
  ...
  function aIQ() {
    i.j(
      ...
      new k(
        L(300),
        b2.ow.yU(
          [L(309), L(310), "Discord", L(311), L(226), L(312), L(88), L(313), L(314), L(315)],
          [bA.a6r, bA.wP, bA.a6s, bA.aIV, bA.aIW, bA.w7, bA.aIX, bA.aIY, bA.aIZ, bA.aIB]
        ),
        false,
        [
          new l(
  ...
  function aIR() {
    i.j(
      4,
      1,
      new k(L(301), dT + "<br><a href='" + bA.aIV + "' target='_blank'>" + bA.aIV + "</a>", true, [
        new l(
          L(13),
          function () {
            i.j(1);
  ...
  function aIS() {
    i.j(
      4,
      1,
      new k(L(302), L(316) + "<br>" + L(317), false, [
        new l(L(13), function () {
          i.j(1);
        }),
  ...
  function wH() {
    ...
    i.j(
      4,
      1,
      new k(L(319), L(320) + "<a href='" + bA.aIB + "' target='_blank'>" + bA.aIB + "</a>", false, [
        new l(
          L(13),
          function () {
            i.j(1);
...
function cQ() {
  ...
  function aIj() {
    ...
    var aIk = Math.floor(1 + 0.02 * an.min);
    aIh = new Array(4);
    aIi = new Array(4);
...
function cX() {
  ...
  function aLU(aLW) {
    ...
    a32 = aLT(
      window.visualViewport && m.id !== 2 ? window.visualViewport.height : document.documentElement.clientHeight
    );
    aLX(q7, a32);
    if (aLW && !aLP) {
      aLP = true;
...
function dA() {
  ...
  this.a0g = function (ey, xo, a3t) {
    ...
    qo.fillStyle = p.mL;
    qo.fillText(
      a3t === 1 ? b2.w0.zB(ez / 100, 2) : b2.w0.z6(Math.floor(ez)),
      -this.q7,
      this.a95 - xo * Math.pow(ez, a3t)
    );
    b2.ow.textAlign(qo, 1);
...
function d3() {
  ...
  this.aPC = function (tb, hA, hB, aPH) {
    ...
    for (z = a1.jN - 1; z >= 0; z--) {
      for (ec = eI; ec >= 1; ec--) {
        ey[ec - 1] =
          Math.abs(4 * tb[z].a9G[0] - aP6[ec][0]) +
          Math.abs(4 * tb[z].a9G[1] - aP6[ec][1]) +
          Math.abs(4 * tb[z].a9G[2] - aP6[ec][2]);
      }
      aPI = 768;
      for (ec = eI - 1; ec >= 0; ec--) {
        d = (ec + z) % eI;
...
function cZ() {
  ...
  this.qn = function () {
    ...
    a9.a0g(
      Math.floor(this.a96[0] + this.a96[2] - 0.7 * a32),
      Math.floor(this.a96[1] + 0.3 * a32),
      Math.floor(0.4 * a32)
    );
    qo.setTransform(1, 0, 0, 1, 0, 0);
  };
